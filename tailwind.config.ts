		...
		extend: {
			colors: {
				...
				zen: {
					...
					'blue-foreground': 'hsl(var(--zen-blue-foreground))'
				},
				nature: {
					green: 'hsl(var(--nature-green))',
					'green-foreground': 'hsl(var(--nature-green-foreground))'
				},
				sunset: {
					orange: 'hsl(var(--sunset-orange))',
					'orange-foreground': 'hsl(var(--sunset-orange-foreground))'
				},
				cloud: {
					gray: 'hsl(var(--cloud-gray))',
					'gray-foreground': 'hsl(var(--cloud-gray-foreground))'
				}
			},
			backgroundImage: {
			...
			animation: {
				...
				'zen-pulse': 'zen-pulse 2s ease-in-out infinite'
			}
		}
	},
